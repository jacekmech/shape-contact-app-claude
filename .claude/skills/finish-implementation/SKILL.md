...
description: "Conclude implementation for the active feature after all slices are completed and validated by marking the Implementation Plan as `done` and making the finished state explicit."
---
