---
name: "finish feature"
description: "Conclude implementation for the active feature after all slices are `done` and validated by verifying repository readiness for completion, marking the Implementation Plan as `done`, and making the finished state explicit."
---
