---
name: "update prd"
description: "Add a new PRD Specification Update or continue refining an existing draft update after the PRD baseline is already `ready`, while preserving append-only change handling and Product Owner ownership of requirement-level changes."
---
