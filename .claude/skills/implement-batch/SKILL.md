...
description: "Execute an explicitly approved developer-selected batch of implementation tasks in code, update the live implementation artifact to reflect resulting execution state, and hand the result off for developer review without crossing the approval boundary or silently expanding batch scope."
---
