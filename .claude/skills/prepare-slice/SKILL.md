---
name: "prepare slice"
description: "Expand a selected implementation slice into executable implementation tasks while keeping the slice small enough for a focused agent session and preserving developer control over task scope and sequencing."
---
